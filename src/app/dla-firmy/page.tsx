...
// Обновленный список услуг (6 разделов)
const services = [
  { title: "Audyt energetyczny", desc: "Szczegółowa analiza profilu zużycia mocy i optymalizacja kosztów." },
  { title: "Instalacje fotowoltaiczne", desc: "Projektowanie i montaż systemów PV o wysokiej wydajności." },
  { title: "Magazyny energii", desc: "Zwiększenie autokonsumpcji i niezależność energetyczna firmy." },
  { title: "Zarządzanie energią", desc: "Inteligentne systemy EMS do kontroli przepływów energii." },
  { title: "Usługi serwisowe", desc: "Profesjonalna konserwacja i zapewnienie ciągłości pracy instalacji." },
  { title: "Monitoring 24/7", desc: "Pełny podgląd parametrów pracy systemu w czasie rzeczywistym." }
]
    ...
    <main className="min-h-screen bg-[#f9f9fb] font-sans overflow-x-hidden">
      ...
      <section className="relative z-30 -mt-10 w-full bg-[#f9f9fb] rounded-t-[24px] shadow-[0_-20px_50px_rgba(0,0,0,0.15)]">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible" // Изменил animate на whileInView для плавности при скролле
          viewport={{ once: true }}
        >
              ...
              <div className="grid gap-4 md:gap-5">
                {services.map((item, idx) => (
                  <motion.div
                    ...
                    whileHover={{ y: -6, x: 5 }}
                    className="p-8 rounded-[18px] bg-white/80 backdrop-blur-md border border-zinc-100 shadow-sm hover:shadow-xl transition-all duration-500 group cursor-pointer"
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-zinc-50 flex items-center justify-center group-hover:bg-[#ff5a1f] group-hover:text-white transition-all">
