    ...
    <main className="relative min-h-screen bg-[#050505]">
      ...
      <section className="relative h-[92vh] w-full flex items-end pb-20 overflow-hidden group">
        ...
        <motion.div {...fadeInUp} className="relative z-20 max-w-[1440px] mx-auto px-8 w-full">
          ...
          <Link href="/dla-firmy">
            <button className="px-12 py-5 border border-white text-white rounded-full font-medium transition-all duration-300 text-sm uppercase tracking-widest hover:bg-white hover:text-black backdrop-blur-md">
              Sprawdź ofertę
            </button>
          </Link>
        </motion.div>
      ...
      <section className="relative w-full flex flex-col md:flex-row gap-[7px] bg-[#F7F6F2] p-[7px]">
        ...
        <div className="relative flex-1 aspect-square md:aspect-auto md:h-[80vh] overflow-hidden rounded-sm bg-zinc-900 group">
          ...
          <motion.div {...fadeInUp} className="relative z-20 h-full flex flex-col items-center justify-end text-center px-8 pb-12 md:pb-20">
            ...
            <button className="px-10 py-4 rounded-full font-medium text-[10px] uppercase tracking-[0.2em] transition-all duration-300 border border-white text-white group-hover:bg-white group-hover:text-black backdrop-blur-md">
              Dowiedz się więcej
            </button>
          </motion.div>
        </div>
